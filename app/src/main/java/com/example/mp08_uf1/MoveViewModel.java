...
public class MoveViewModel extends ViewModel {
    ...
    public MoveViewModel() {
        ...
        moveList.add(new Move("Dash Vault", "A vault using one hand and legs extended forward", R.drawable.baseline_directions_run_24, 7, "Vaults", "https://www.youtube.com/watch?v=dashvault", false));
        moveList.add(new Move("Tic Tac", "Push off a wall to change direction or gain height", R.drawable.baseline_directions_run_24, 6, "Wall Moves", "https://www.youtube.com/watch?v=tictac", false));
        moveList.add(new Move("Lazy Vault", "A smooth vault using one hand and one leg", R.drawable.baseline_directions_run_24, 5, "Vaults", "https://www.youtube.com/watch?v=lazyvault", false));
        moveList.add(new Move("Underbar", "Swing through a bar or gap", R.drawable.baseline_directions_run_24, 6, "Bar Moves", "https://www.youtube.com/watch?v=underbar", false));
        moveList.add(new Move("Cat Grab", "Jump to a wall and grab onto a ledge", R.drawable.baseline_directions_run_24, 7, "Climbing", "https://www.youtube.com/watch?v=catgrab", false));
        ...
        moveList.add(new Move("Roll", "A forward roll to absorb impact", R.drawable.baseline_directions_run_24, 4, "Safety", "https://www.youtube.com/watch?v=parkourroll", false));
        ...
        moveList.add(new Move("Wall Climb", "Climb up a tall wall with momentum", R.drawable.baseline_directions_run_24, 8, "Climbing", "https://www.youtube.com/watch?v=wallclimb", false));
        moveList.add(new Move("Turn Vault", "Vault over an obstacle while turning mid-air", R.drawable.baseline_directions_run_24, 6, "Vaults", "https://www.youtube.com/watch?v=turnvault", false));
        ...
        moveList.add(new Move("Dive Roll", "A roll performed after a dive", R.drawable.baseline_directions_run_24, 6, "Safety", "https://www.youtube.com/watch?v=diveroll", false));
        ...
        moveList.add(new Move("Stride", "Leaping from one point to another using long steps", R.drawable.baseline_directions_run_24, 5, "Jumps", "https://www.youtube.com/watch?v=stride", false));
